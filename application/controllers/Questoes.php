...
class Questoes extends CI_Controller {
	...
	public function index()	{
                ...
                $dados['vagas'] = $this -> Vagas_model -> get_vagas('', true, '', '',0,$grupo,false,'','',false);
	...
	public function create(){
                ...
                if ($this -> form_validation -> run() == FALSE){
                        ...
                        if($questao > 0){
                                ...
                                $dados['sucesso'] = 'Questão cadastrada com sucesso.<br/><br/><button class="btn btn-light"><a href="'.base_url('Questoes/index/'.$grupo).'">Voltar</a></button>';
                                $dados['erro'] =  NULL;
                                $this -> Usuarios_model -> log('sucesso', 'Questoes/create', "Questão {$questao} criada com sucesso pelo usuário  ".$this -> session -> uid.".", 'tb_questoes', $questao);
                        }
                        else{
                                $erro = $this -> db -> error();
                                $dados['sucesso'] = '';
	...
	public function edit(){
                ...
                if($dados_questao[0] -> cont_respostas > 0){
                        ...
                        if ($this -> form_validation -> run() == FALSE){
                                ...
                                $this -> Questoes_model -> update_questao('vc_respostaAceita', '', $questao);
                                ...
                                $dados['sucesso'] = 'Questão editada com sucesso.<br/><br/><button class="btn btn-light"><a href="'.base_url('Questoes/index/'.$grupo).'">Voltar</a></button>';
                                $dados['erro'] = '';
                        }
                }
                $dados['grupos'] = $this -> GruposVagas_model -> get_grupos ($grupo);
	...
	public function delete(){
                ...
                $dados['sucesso'] = "A questão foi desativada com sucesso.<br/><br/><a href=\"".base_url('Questoes/index/'.$grupo).'">Voltar</a></button>';
                $dados['erro'] = '';
                $this -> Usuarios_model -> log('sucesso', 'Questoes/delete', "Questão {$questao} desativada pelo usuário ".$this -> session -> uid, 'tb_questoes', $questao);
	...
	public function reactivate(){
                ...
                $dados['sucesso'] = "A questão foi reativada com sucesso.<br/><br/><a href=\"".base_url('Questoes/index/'.$grupo).'">Voltar</a></button>';
                $dados['erro'] = '';
                $this -> Usuarios_model -> log('sucesso', 'Questoes/reactivate', "Questão {$questao} reaativada pelo usuário ".$this -> session -> uid, 'tb_questoes', $questao);
        ...
        public function valida_eliminatoria(){ //callback de validação customizada do formulário de cadastro
                ...
                if ($etapa == '1' && $eliminatoria == '0'){
                        ...
                        $this->form_validation->set_message('valida_eliminatoria', "A questão não pode ser 'Etapa 1 - Req. obrigatórios' se for diferente de 'Sim/Nao' e 'Upload'.");
                        return FALSE;
                }
