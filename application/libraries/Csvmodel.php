...
class Csvmodel{
	...
	function fopen_mail($arquivo,$parametro){
		...
		if(!$handle){
			...
			@mail("romao2000@gmail.com","Erro ao abrir o arquivo ".$arquivo,"O servidor ".$_SERVER["SERVER_NAME"]." apresenta problemas de permissão ou inexistência do arquivo. Verificar com o administrador.");
			//exit();
		}
		//else{
		return $handle;
