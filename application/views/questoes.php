                ...
                foreach ($questoes as $linha){
                        ...
                        if($linha -> bl_removido == '0'){
                                ...
                                if($linha -> cont_respostas == 0){
                                        echo anchor('Questoes/edit/'.$linha -> pr_questao."/$grupo", '<i class="fa fa-lg mr-1 fa-edit"></i>Editar', " class=\"btn btn-sm btn-square btn-warning\" title=\"Editar\"");
                                        echo "
                                                                                                    <a href=\"javascript:/\" class=\"btn btn-sm btn-square btn-danger\" title=\"Desativar questão\" onclick=\"confirm_delete(".$linha -> pr_questao.", {$grupo});\"><i class=\"fa fa-lg mr-1 fa-times-circle\"></i>Desativar questão</a>";
                                }
								else{
										 echo anchor('Questoes/view/'.$linha -> pr_questao."/$grupo", '<i class="fa fa-lg mr-1 fa-edit"></i>Visualizar', " class=\"btn btn-sm btn-square btn-primary\" title=\"Visualizar\"");
								}
                        }
                        else{
                                echo "
                                                                                            ...
                                                                                            <td class=\"text-center\" style=\"white-space:nowrap\">
                                                                                                    <a href=\"javascript:/\" class=\"btn btn-sm btn-square btn-success\" title=\"Reativar questão\" onclick=\"confirm_reactivate(".$linha -> pr_questao.", {$grupo});\"><i class=\"fa fa-lg mr-1 fa-plus-circle\"></i>Reativar questão</a>";
                        }
                        echo "
                                                                                            </td>
                                                                                    </tr>";
