...
/*else if($menu2 == 'index_removido'){ //lista de candidaturas - perfil candidato
        echo "
                                                            <div class=\"row sub-title\" style=\"letter-spacing:0px\">
                                                                    <div class=\"col-lg-8\">
                                                                            <h4><i class=\"$icone\" style=\"color:black\"></i> &nbsp; {$nome_pagina}</h4>
        ...
        echo "
                                                                    <div class=\"col-lg-4 text-right\">
                                                                            <a href=\"".base_url('Candidaturas/index')."\" class=\"btn btn-primary btn-square\"> Voltar </a>
                                                                    </div>";
        ...
        if(isset($candidaturas)){
                foreach ($candidaturas as $linha){
                        ...
                        echo "
                                                                                            <td class=\"text-center\">";
                        //}
                        echo anchor('Candidaturas/DetalheAvaliacao/'.$linha -> pr_candidatura, '<i class="fa fa-lg mr-0 fa-search"></i>', " class=\"btn btn-sm btn-square btn-primary\" title=\"Detalhes\"");
                ...
                echo "
                                                                                    <tr>
                                                                                            <td colspan=\"5\">Você não possui candidaturas registradas</td>
                                                                                    </tr>
                ";
        }
        echo "
        ...
        if($menu2 != 'TesteAderencia' && $menu2!= 'delete'){
                ...
                echo "
                        ...
                        if($menu2 == 'create'){
                                echo "
                                                                                    <li role=\"tab\" class=\"first current\" aria-disabled=\"false\" aria-selected=\"true\" style=\"width:20%\">";
                        }
                        else{
                                echo "
                        ...
                        echo "
                                                                                        <a id=\"example-advanced-form-t-3\" href=\"#example-advanced-form-h-3\" aria-controls=\"example-advanced-form-p-3\">
                                                                                            <span class=\"number\">5.</span>  Rever e concluir
                                                                                        </a>
                                                                                    </li>";
                        echo "
                                                                                </ul>
                        ...
                        if(!isset($vaga)){
                                echo "
											<div class=\"alert alert-info\">
												...
												<h5 class=\"mb-2 font-weight-bold\">Orientações:</h5>

												Prezados(as) candidatos(as), conforme explicitado nos editais do Processo Seletivo Simplificado das vagas Pró Brumadinho, o candidato deverá se inscrever em somente UMA vaga de cada edital. Para aqueles candidatos que se inscreverem em mais de uma vaga de um mesmo edital, será considerada somente a última candidatura realizada.
                                        ...
                                        <div class=\"row px-1\">
                                                <div class=\"col-sm-12\">
                                                        ...
                                                        <div class=\"form-group row lx-3\"></div>
                                                                ...
                                                                <h6 style=\"font-weight:600\">Cargo:</h6>
                                                                ...
                                                                <h6 style=\"font-weight:600\">Orientações:</h6>
                                                                ...
                                                                <h6 style=\"font-weight:600\">Requisitos mínimos:</h6>
                                                ...
                                                if (this.id == 'cadastrar') {
                                                        ...
                                                        $(document).ready(function(){
                                                                ...
                                                                swal.fire({
                                                                        ...
                                                                        text: 'Prezado(a) candidato(a), ao confirmar essa ação não será mais possível se cadastrar em outras vagas referentes ao mesmo edital.',
                                                                        type: 'warning',
                                                                        showCancelButton: true,
                        ...
                        echo "
																					<div class=\"alert alert-info\">
																							<h5 class=\"mb-2 font-weight-bold\"> Atenção!!! </h5>
                                                                                                                                                                                        ...
                                                                                                                                                                                        durante a inscrição.<br /><br />
																							<i class=\"font-weight-bold\">Observação:</i> caso tenha problema para salvar os anexos, preencha o curriculo em partes, salvando os dados digitados juntamente aos anexos. Somente prossiga até verificar que todos os documentos foram inseridos. Se o total de arquivos ultrapassar 8mb, faça o upload por partes (Ex: 4 arquivos de 2mb) e salve, até inserir todos os arquivos.<br />
																					</div>";*/
                    ...
                    if (this.id == 'Salvar') {
                        ...
                        $(document).ready(function(){
                            ...
                            if (tamanho_total <= 2097152*4) {
                                ...
                                alert('O total de upload não pode passar 8mb. Salve uma parte e insira os outros arquivos posteriormente.');
                            }
                        });
                    }
                    if (this.id == 'Avancar') {
                        ...
                        if(strlen($sucesso) == 0 || (strlen($sucesso) > 0 && isset($_POST['cadastrar']) && $_POST['cadastrar'] == "Salvar")){
                                ...
                                echo "
                                                            <div class=\"alert alert-info\">
                                                                    ...
                                                                    Prezados(as) candidatos(as), revise todas as etapas da sua candidatura antes de concluir, ela somente será aceita pelo sistema após clicar no botão CONCLUIR. Essa ação é irreversível.
...
echo "
                        ...
                        echo "
                                ...
                                //echo form_submit('cadastrar', 'Candidatar-se', $attributes);
                        echo "
                                                                                        <button type=\"reset\" class=\"btn btn-warning\" onclick=\"window.location='".base_url('Candidaturas/Questionario/'.$vaga)."';\">Voltar</button>";
